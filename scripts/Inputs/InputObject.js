...
function InputObject(_canvas, _m, _l, _t, _w, _h) {
    $U.extend(this, new InputText(_canvas.getDocObject())); //modificar
	
    var me = this;
    var Cn = _canvas.getConstruction();
    me.setAttr("className", "inputPanel");
	...
	me.getinputFont = function () {
		return inputFont;
	};
	
	me.setinputFont = function (val) {
		inputFont=val;
		me.setStyle("font-size",inputFont+"pt");

...
function SymaArcObject(_construction, _name, _L, _A) {
	...
	ext1=new SymaPointObject(_construction, "_P", _L, _A.getA());
	_construction.add(ext1);
	
	ext2= new SymaPointObject(_construction, "_P", _L, _A.getB());
	
	_construction.add(ext2);
	ext3= new SymaPointObject(_construction, "_P", _L, _A.getC());

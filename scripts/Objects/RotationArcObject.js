...
function RotationArcObject(_construction, _name, _E, _A, _P) {
	...
	ext1=new RotationPointObject(_construction, "_P", _E, _A.getA(), _P);
	_construction.add(ext1);
	
	ext2= new RotationPointObject(_construction, "_P", _E, _A.getB(), _P);
	
	_construction.add(ext2);
	ext3= new RotationPointObject(_construction, "_P", _E, _A.getC(), _P);

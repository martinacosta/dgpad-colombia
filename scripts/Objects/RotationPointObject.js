//************************************************
//*************** Rotation Point OBJECT ****************
//************************************************
function RotationPointObject(_construction, _name, _Ex, _P1, _P2) {
    ...
    this.getSource = function(src) {
      ...
      src.geomWrite(false, this.getName(), "Rotation", angle.getVarName(), p1.getVarName(), p2.getVarName());
    };

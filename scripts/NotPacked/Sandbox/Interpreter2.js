...
//Restricciones
	...
	// copy, name, grid, zoom, OtherTools, redo, undo
    ...
    EX.EX_d = function(_a, _b) {
		...
		// distancia punto/recta--funciona si se pone la recta entre comillas
		if ((!isArray(_a))&&(isArray(_b))){
			if (isNaN(_a)) {a=me.f(_a)};
			return Math.sqrt((_b[0] - a.projectxy(_b[0],_b[1])[0]) * (_b[0] - a.projectxy(_b[0],_b[1])[0]) + (_b[1] - a.projectxy(_b[0],_b[1])[1]) * (_b[1] - a.projectxy(_b[0],_b[1])[1]));
			
		}
		if ((isArray(_a))&&(!isArray(_b))){
			
			return Math.sqrt((_a[0] - me.f(_b).projectxy(_a[0],_a[1])[0]) * (_a[0] - me.f(_b).projectxy(_a[0],_a[1])[0]) + (_a[1] - me.f(_b).projectxy(_a[0],_a[1])[1]) * (_a[1] - me.f(_b).projectxy(_a[0],_a[1])[1]));

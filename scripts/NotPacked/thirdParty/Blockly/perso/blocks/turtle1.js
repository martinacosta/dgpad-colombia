...
Blockly.Blocks['turtle_length'] = {
    ...
    init: function() {
        ...
        this.appendDummyInput()
            .appendField($L.blockly.turtleInput_color);
        this.appendValueInput("N")
            .setCheck("Number");
        this.appendDummyInput("rgb")
            .appendField(new Blockly.FieldColour("#ff0000", function(option) {
        ...
        this.appendValueInput("BackColor")
            .setCheck(null)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField($L.blockly.turtleInput_backColor);
...
Blockly.Blocks['turtle_inputNum'] = {
    init: function() {
        ...
        this.appendValueInput("min")
            .setCheck(null)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField($L.blockly.turtleInput_min);
        this.appendValueInput("max")
            .setCheck(null)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField($L.blockly.turtleInput_max);

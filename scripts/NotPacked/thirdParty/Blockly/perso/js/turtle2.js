...
Blockly.JavaScript['turtle_input'] = function(block) {
    ...
    // var value_BackColor = Blockly.JavaScript.valueToCode(block, 'BackColor', Blockly.JavaScript.ORDER_ATOMIC);
	...
	var code = "TURTLE_INPUT("+value_name+"," + value_width + ","+value_FontSize+","+value_target+");\n"; 
	
    return code;
};

// Blockly.JavaScript['turtle_inputNum'] = function(block) {
    // var value_width = Blockly.JavaScript.valueToCode(block, 'width', Blockly.JavaScript.ORDER_ATOMIC);
	...
	// var value_target = Blockly.JavaScript.valueToCode(block, 'target', Blockly.JavaScript.ORDER_ATOMIC);
	// var value_name = Blockly.JavaScript.valueToCode(block, 'name', Blockly.JavaScript.ORDER_ATOMIC);
	// var code = "TURTLE_INPUT("+value_name+"," + value_width + ","+value_FontSize+","+value_target+","+value_min+","+value_max+");\n"; 
